 ...
 */
final class Version20200213221408 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE episode CHANGE anime_id anime_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE episode CHANGE anime_id anime_id INT DEFAULT NULL');
    }
}
