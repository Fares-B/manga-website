 ...
 */
final class Version20200307150127 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comment_anime (comment_id INT NOT NULL, anime_id INT NOT NULL, INDEX IDX_BA9EC1B3F8697D13 (comment_id), INDEX IDX_BA9EC1B3794BBE89 (anime_id), PRIMARY KEY(comment_id, anime_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
