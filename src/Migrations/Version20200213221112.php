 ...
 */
final class Version20200213221112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD format_id INT NOT NULL, DROP format, CHANGE anime_id anime_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD format VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP format_id, CHANGE anime_id anime_id INT DEFAULT NULL');
    }
}
